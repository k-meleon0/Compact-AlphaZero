...
void save_Q_value(int nodeArray[], int root, float history_of_Q_value[], int turn) {
  history_of_Q_value[turn] = decode_float(nodeArray, root + 4);
}

void save_board(bool history_of_board[MAX_MOVES][INPUT_DIM], int turn, bool NNboard[INPUT_DIM]) {
