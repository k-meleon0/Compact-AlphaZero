...
class TrainingManager():
    ...
    def train_model_on_data(self):
        ...
        This function performs all data processing (moving data to training{generation}.txt, sample dataset etc.). """
        dataset.copy_to_file(self.current_generation)
        # Sliding windown of 8 files, so that each game output 8 positions
        begin_id = max(0, self.current_generation - 15)
